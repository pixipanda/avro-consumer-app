 ...
 */
    public class AvroPageViewConsumerV1 implements Runnable{

    private final KafkaConsumer<String, PageView> consumer;
    private final String topic;


    public AvroPageViewConsumerV1(String brokers, String groupId, String topic, String schemaRegistryUrl) {
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, PageView> record : records) {
                ...
                System.out.println("Receive message: { " + " ip: " + pageView.getIp() + ", page: " + pageView.getPage() + ", time:"
                        + pageView.getTime()+ " }, Partition: " + record.partition() + ", Offset: " + record.offset() + ", by ThreadID: "
                        + Thread.currentThread().getId());
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        AvroPageViewConsumerV1 consumer = new AvroPageViewConsumerV1("localhost:9092", groupID, topic,schemaRegistryUrl);
